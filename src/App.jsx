...
export default function App() {
  ...
  const content = useMemo(
    () => ({
      ...
      meetDate: "2026-02-13",
      timerTitle: "من أول يوم قابلتك ❤️",
      timerText:
        "كل يوم بيعدي بيأكدلي إنك أجمل حاجة حصلتلي، وإن وجودك هو الأمان والفرحة اللي كنت بدور عليهم ❤️",
      longMessage:
  ...
  const memoryCards = useMemo(
    () => [
      {
        id: 1,
        title: "من أول يوم يا رانيا ",
        image: "/1.jpg",
        date: "2026-02-23",
        text: "من أول يوم قابلتك… قلبي عرف إنك نصه التاني 💖",
      },
      {
        id: 2,
        title: "روحي RANIA",
        image: "/2.jpg",
        date: "ذكرى مميزة",
        text: "إنتي مش بس خطيبتي، إنتي صاحبة قلبي وأفضل صديقة لي 💞",
      },
      {
        id: 3,
        title: "العُمر  RANIA❤️",
        image: "/3.jpg",
        date: "أجمل لحظة",
        text: "بحبك قد الدنيا وكل يوم بحبك أكتر من اللي قبله ❤️",
      },
      {
        id: 4,
        title: "كل سنه وانتي عيد RANIA",
        image: "/4.jpg",
        date: "أحلى يوم",
        text: "إنتي الأمان والفرحة اللي نفسي تفضل معايا طول العمر ❤️",
      },
    ],
    []
  );
  ...
  const handleUnlock = async (e) => {
    ...
    if (enteredPassword === SITE_PASSWORD) {
      ...
      setError("الباسورد غلط يا قلبي RANIA ");
    }
  };
  ...
  if (showLoader) {
    return (
      <div className="loader-page" dir="rtl">
        ...
        <h1>جارِ تجهيز أجمل مفاجأة ليكي RANIA 💖</h1>
      </div>
    );
  }
    ...
    return (
      <div className="password-page" dir="rtl">
        ...
        <div className="password-card glass">
          ...
          <h1>اكتبي كلمه السر يا حلوتي ويا جميلتي RANIA</h1>
          ...
          <form onSubmit={handleUnlock} className="password-form">
            <input
              type="password"
              placeholder="اكتبي كلمة السر هنا RANIA "
      ...
      <main className="container">
        ...
        <section className="big-quotes-section glass">
          <div className="quote-box">
            “من أول يوم قابلتك… قلبي عرف إنك نصه التاني RANIAA💖”
          </div>
          <div className="quote-box">
            “إنتي مش بس خطيبتي، إنتي صاحبة قلبي وأفضل صديقة لي RANIA💞”
          </div>
          <div className="quote-box">
            “بحبك قد الدنيا وكل يوم بحبك أكتر من اللي قبله RANIA❤️”
          </div>
        </section>
        ...
        <section className="extra-love-section glass">
          <div className="extra-love-card glass">
            <h3>وجودك فرق</h3>
            <p>خلّى كل حاجة في حياتي أخف وأجمل وأهدى RANIA❤️</p>
          </div>
          <div className="extra-love-card glass">
            <h3>قلبي مطمّن</h3>
          ...
          <div className="extra-love-card glass">
            <h3>أجمل قدر</h3>
            <p>إنتي أحلى صدفة وأحلى نصيب وأحلى هدية من ربنا RANIA🌷</p>
          </div>
        </section>

        <section className="final-cute-section glass">
          <h2>وفي الآخر…</h2>
          <p>إنتي أجمل حاجة حصلتلي، وأحلى قصة أنا عايشها RANIA❤️</p>
        </section>
